...
class AddForeignKeysToPeerToPeerEvaluationTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('peer_to_peer_evaluation', function (Blueprint $table) {
            ...
            $table->foreign(['idplanning'], 'fk_peer_to__relations_planning')->references(['idplanning'])->on('planning')->onUpdate('RESTRICT')->onDelete('RESTRICT');
    ...
    public function down()
    {
        Schema::table('peer_to_peer_evaluation', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_peer_to__relations_planning');
