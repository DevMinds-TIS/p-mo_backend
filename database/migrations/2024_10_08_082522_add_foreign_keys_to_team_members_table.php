...
class AddForeignKeysToTeamMembersTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('team_members', function (Blueprint $table) {
            ...
            $table->foreign(['idrol'], 'fk_team_mem_relations_roles')->references(['idrol'])->on('roles')->onUpdate('RESTRICT')->onDelete('RESTRICT');
    ...
    public function down()
    {
        Schema::table('team_members', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_team_mem_relations_roles');
