...
class AddForeignKeysToTasksTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('tasks', function (Blueprint $table) {
            $table->foreign(['idweeklie'], 'fk_tasks_relations_weeklies')->references(['idweeklie'])->on('weeklies')->onUpdate('RESTRICT')->onDelete('RESTRICT');
    ...
    {
        Schema::table('tasks', function (Blueprint $table) {
            $table->dropForeign('fk_tasks_relations_weeklies');
